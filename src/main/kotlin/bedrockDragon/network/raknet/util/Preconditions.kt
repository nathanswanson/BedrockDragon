 ...
 *
 *
 * Projects which use `com.google.common` should generally avoid the use of [ ][java.util.Objects.requireNonNull]. Instead, use whichever of [ ][.checkNotNull] is appropriate to the situation.
...
object Preconditions {
    ...
    fun checkArgument(b: Boolean, errorMessageTemplate: String?, p1: Char) {
        require(b) { format(errorMessageTemplate, p1) }
    }
    ...
    fun checkArgument(
        ...
        require(b) { format(errorMessageTemplate, p1, p2) }
    }
    ...
    fun checkArgument(
        ...
        require(b) { format(errorMessageTemplate, p1, p2, p3) }
    }
    ...
    fun checkArgument(
        ...
        require(b) { format(errorMessageTemplate, p1, p2, p3, p4) }
    }
    ...
    fun checkState(b: Boolean, errorMessageTemplate: String?, p1: Char) {
        check(b) { format(errorMessageTemplate, p1) }
    }
    ...
    fun checkState(
        ...
        check(b) { format(errorMessageTemplate, p1, p2) }
    }
    ...
    fun checkState(
        ...
        check(b) { format(errorMessageTemplate, p1, p2, p3) }
    }
    ...
    fun checkState(
        ...
        check(b) { format(errorMessageTemplate, p1, p2, p3, p4) }
    }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Any?
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Char, p2: Any?
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Int, p2: Any?
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Long, p2: Any?
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Any?, p2: Char
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Any?, p2: Int
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Any?, p2: Long
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
     ...
     */
    fun <T> checkNotNull(
        obj: T?, errorMessageTemplate: String?, p1: Any?, p2: Any?
    ): T {
        if (obj == null) {
            throw NullPointerException(format(errorMessageTemplate, p1, p2))
        }
    ...
    fun format(template: String?, vararg args: Any?): String {
        ...
        args = args ?: arrayOf<Any?>("(Object[])null")
