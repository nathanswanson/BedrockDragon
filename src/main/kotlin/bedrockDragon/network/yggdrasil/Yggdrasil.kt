package bedrockDragon.network.yggdrasil

import bedrockDragon.DragonServer
import bedrockDragon.network.yggdrasil.models.Game
import bedrockDragon.network.yggdrasil.models.TokenPair
...
object Yggdrasil {
     ...
     * @author dewy
     */
    suspend fun authenticate(username: String, password: String, game: Game = Game.MINECRAFT, clientToken: UUID = UUID.randomUUID(), callBack: (TokenPair) -> Unit)
    {
